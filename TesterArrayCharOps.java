...
public class TesterArrayCharOps {
    ...
    private static void testCharAt() {
        int num_tests = 4;
        System.err.println("Testing 'charAt':");
        ...
        System.err.println("Passed " + passed + "/" + num_tests + " tests " + verdict);
    }


    private static void testEquals() {
        int num_tests = 3;
        System.err.println("Testing 'equals':");
    ...
    private static void testIndexOf() {
        int num_tests = 7;
        System.err.println("Testing 'indexOf' functions:");
    ...
    private static void testConcat() {
        int num_tests = 3;
        System.err.println("Testing 'concat':");
    ...
    private static void testSubArray() {
        ...
        System.err.println("Testing 'subArray':");
    ...
    private static void testCompareTo() {
        int num_tests = 4;
        System.err.println("Testing 'compareTo'");
    ...
    private static void testHashCode() {
        int num_tests = 3;
        System.err.println("Testing 'hashCode':");
